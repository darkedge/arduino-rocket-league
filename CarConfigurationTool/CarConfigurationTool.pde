...
void setup()
{
  ...
  final int spacer = 20;
  int y = 20;
  cp5.addTextfield("IpAddress").setPosition(20, y).setSize(200, height).setAutoClear(false);
  y += height + spacer;
  cp5.addTextfield("Subnet Mask").setPosition(20, y).setSize(200, height).setAutoClear(false);
  y += height + spacer;
  cp5.addTextfield("Gateway").setPosition(20, y).setSize(200, height).setAutoClear(false);
  y += height + spacer;
  cp5.addTextfield("SSID").setPosition(20, y).setSize(200, height).setAutoClear(false);
  y += height + spacer;
  cp5.addTextfield("Password").setPosition(20, y).setSize(200, height).setAutoClear(false);
  y += height + spacer;
